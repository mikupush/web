...
We are using [ShadCN](https://ui.shadcn.com/docs/components) components and React for components that require interaction, or it should be reusable both client and static.
